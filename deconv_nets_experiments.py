...
# Train model
args['n_levels'] = 3
args['result_path'] = './Mu_Net_res_3_levels'
...
# Train model
args['n_levels'] = 2
args['result_path'] = './Mu_Net_res_2_levels'
data_provider = DataProvider((args['z_shape'], args['xy_shape']), args['data_path'], args['source_folder'],
                             args['target_folder'],
                             data_file='C:/Users/jo77pihe/Documents/MasterThesis_OfSpinesAndDendrites/data32_128.h5')
deconvolver = REGISTRY['mu-net'](args)
...
# Train model
args['n_levels'] = 1
args['result_path'] = './Mu_Net_res_1_levels'
data_provider = DataProvider((args['z_shape'], args['xy_shape']), args['data_path'], args['source_folder'],
                             args['target_folder'],
                             data_file='C:/Users/jo77pihe/Documents/MasterThesis_OfSpinesAndDendrites/data32_128.h5')
deconvolver = REGISTRY['mu-net'](args)
...
# Train model
args['n_levels'] = 0
args['result_path'] = './Mu_Net_res_0_levels'
data_provider = DataProvider((args['z_shape'], args['xy_shape']), args['data_path'], args['source_folder'],
                             args['target_folder'],
                             data_file='C:/Users/jo77pihe/Documents/MasterThesis_OfSpinesAndDendrites/data32_128.h5')
deconvolver = REGISTRY['mu-net'](args)
